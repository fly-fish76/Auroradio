...
// lx 自定义音源脚本运行时 preload
// 逐字移植自 lx-music-desktop src/main/modules/userApi/renderer/preload.js (GPL-3.0)
// 向隐藏窗口暴露 window.lx 契约: EVENT_NAMES / send / on / request(needle) /
// utils.crypto / utils.buffer / utils.zlib / currentScriptInfo
